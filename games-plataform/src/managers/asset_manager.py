...
class AssetManager:
    ...
    def _load_images(self):
        ...
        image_files = {
            ...
            'paciencia_icon': 'images/paciencia_icon.PNG',
            'jogo_da_velha_icon': 'images/jogo_da_velha_icon.PNG',
            'blackjack_icon': 'images/blackjack_icon.PNG',
    ...
    def _create_placeholder(self, key, filename):
        ...
        sizes = {
            ...
            'poker_icon': (300, 300),
            'paciencia_icon': (300, 300),
            'jogo_da_velha_icon': (800, 800),
            'blackjack_icon': (300, 300),
            'arrow_left': (100, 100),
            'arrow_right': (100, 100),
            'back_arrow': (100, 100),
            'menu_button': (235, 99),
